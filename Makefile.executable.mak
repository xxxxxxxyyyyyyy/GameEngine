...
ifeq ($(OS),Windows_NT)
	...
	EXTENSION := .exe
	COMPILER_FLAGS := -Wall -Werror -Wvla -Werror=vla -Wunused-but-set-variable -Wgnu-folding-constant -Wno-missing-braces -fdeclspec -Wstrict-prototypes -Wno-unused-function
