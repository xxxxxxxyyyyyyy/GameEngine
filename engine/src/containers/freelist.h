 ...
 */
API void freelist_create(u64 total_size, u64* memory_requirement, void* memory, freelist* out_list);
 ...
 */
API void freelist_destroy(freelist* list);
 ...
 */
API b8 freelist_allocate_block(freelist* list, u64 size, u64* out_offset);
 ...
 */
API b8 freelist_free_block(freelist* list, u64 size, u64 offset);
 ...
 */
API void freelist_clear(freelist* list);
 ...
 */
API u64 freelist_free_space(freelist* list);
 ...
 */
API b8 freelist_resize(freelist* list, u64* memory_requirement, void* new_memory, u64 new_size, void** out_old_memory);