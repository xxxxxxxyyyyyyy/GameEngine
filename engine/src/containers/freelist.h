 ...
 */
API void freelist_create(u32 total_size, u64* memory_requirement, void* memory, freelist* out_list);
 ...
 */
API b8 freelist_allocate_block(freelist* list, u32 size, u32* out_offset);
 ...
 */
API b8 freelist_free_block(freelist* list, u32 size, u32 offset);
