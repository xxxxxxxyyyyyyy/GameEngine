 ...
 * @returns If successful, a pointer to a block of allocated memory; otherwise 0.
 */
API void* kallocate_aligned(u64 size, u16 alignment, memory_tag tag);
 ...
 * @param tag Indicates the use of the allocated block.
 */
API void kallocate_report(u64 size, memory_tag tag);
 ...
 * @returns If successful, a pointer to a block of allocated memory; otherwise 0.
 */
API void* kreallocate(void* block, u64 old_size, u64 new_size, memory_tag tag);
 ...
 * @returns If successful, a pointer to a block of allocated memory; otherwise 0.
 */
API void* kreallocate_aligned(void* block, u64 old_size, u64 new_size, u16 alignment, memory_tag tag);
 ...
 * @param tag Indicates the use of the allocated block.
 */
API void kreallocate_report(u64 old_size, u64 new_size, memory_tag tag);
 ...
 * @param tag The tag indicating the block's use.
 */
API void kfree_aligned(void* block, u64 size, u16 alignment, memory_tag tag);
 ...
 * @param tag The tag indicating the block's use.
 */
API void kfree_report(u64 size, memory_tag tag);
 ...
 */
API b8 kmemory_get_size_alignment(void* block, u64* out_size, u16* out_alignment);
 ...
 */
API char* get_memory_usage_str(void);
 ...
 */
API u64 get_memory_alloc_count(void);