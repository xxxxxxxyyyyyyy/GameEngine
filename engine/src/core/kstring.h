 ...
 */
API u32 string_utf8_length(const char* str);
 ...
 */
API b8 bytes_to_codepoint(const char* bytes, u32 offset, i32* out_codepoint, u8* out_advance);
 ...
 */
API b8 strings_nequal(const char* str0, const char* str1, u64 length);
 ...
 * @return True if the same, otherwise false.
 */
API b8 strings_nequali(const char* str0, const char* str1, u64 length);
...
API char* string_trim(char* str);

API void string_sub(char* dest, const char* source, i32 start, i32 length);
 ...
 */
API b8 string_to_transform(const char* str, transform* out_transform);
 ...
 * @return True if parsed successfully; otherwise false.
 */
API b8 string_to_mat4(const char* str, matrix4* out_mat);
 ...
 */
API u32 string_split(const char* str, char delimiter, char*** str_darray, b8 trim_entries, b8 include_empty);
 ...
 *
 */
API void string_cleanup_split_array(char** str_darray);
 ...
 */
API void string_append_string(char* dest, const char* source, const char* append);
 ...
 */
API void string_append_int(char* dest, const char* source, i64 i);
 ...
 */
API void string_append_float(char* dest, const char* source, f32 f);
 ...
 */
API void string_append_bool(char* dest, const char* source, b8 b);
 ...
 */
API void string_append_char(char* dest, const char* source, char c);
 ...
 */
API void string_directory_from_path(char* dest, const char* path);
 ...
 * @param path The full path to extract from.
 */
API void string_filename_from_path(char* dest, const char* path);
...
API void kstring_create(kstring* out_string);
API void kstring_from_cstring(const char* source, kstring* out_string);
API void kstring_destroy(kstring* string);

API u32 kstring_length(const kstring* string);
API u32 kstring_utf8_length(const kstring* string);

API void kstring_append_str(kstring* string, const char* s);
API void kstring_append_kstring(kstring* string, const kstring* other);