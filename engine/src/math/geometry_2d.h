#ifndef _DOD_MATH_GEOMETRY_2D_H_
#define _DOD_MATH_GEOMETRY_2D_H_
 ...
 */
INLINE b8 point_in_rect_2d(vec2 point, rect_2d rect) {
 ...
 * @returns True if the point is within the rectangle; otherwise false.
 */
INLINE b8 point_in_circle_2d(vec2 point, circle_2d circle) {
