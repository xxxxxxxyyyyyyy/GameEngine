...
ray ray_from_screen(vec2 screen_pos, rect_2d viewport_rect, vec3 origin, matrix4 view, matrix4 projection) {
    ray r = {0};
    r.origin = origin;
...
b8 raycast_oriented_extents(extents_3d bb_extents, matrix4 model, const ray* r, f32* out_dist) {
