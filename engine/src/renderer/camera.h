 ...
 */
API vec3 camera_position_get(const camera* c);
 ...
 */
API void camera_position_set(camera* c, vec3 position);
 ...
 */
API vec3 camera_rotation_euler_get(const camera* c);
 ...
 */
API matrix4 camera_view_get(camera* c);
 ...
 */
API vec3 camera_backward(camera* c);
 ...
 */
API void camera_move_forward(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
API void camera_move_backward(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
API void camera_move_left(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
API void camera_move_right(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
API void camera_move_up(camera* c, f32 amount);
 ...
 * @param amount The amount to move.
 */
API void camera_move_down(camera* c, f32 amount);
 ...
 */
API void camera_yaw(camera* c, f32 amount);
 ...
 * @param amount The amount to adjust by.
 */
API void camera_pitch(camera* c, f32 amount);