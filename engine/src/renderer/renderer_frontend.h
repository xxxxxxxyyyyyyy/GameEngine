 ...
 * @return True on success; otherwise false.
 */
API b8 renderer_shader_instance_resources_acquire(struct shader* s, texture_map** maps, u32* out_instance_id);
 ...
 * @return API b8 True on success; otherwise false.
 */
API b8 renderer_uniform_set(struct shader* s, struct shader_uniform* uniform, const void* value);
 ...
 * @return True on success; otherwise false.
 */
API b8 renderer_renderbuffer_create(renderbuffer_type type, u64 total_size, b8 use_freelist, renderbuffer* out_buffer);
