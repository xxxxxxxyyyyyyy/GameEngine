 ...
 */
API b8 renderer_system_initialize(u64* memory_requirement, void* state, void* config);
 ...
 */
API void renderer_system_shutdown(void* state);
 ...
 */
API void renderer_set_stencil_test_enabled(b8 enabled);
 ...
 */
API void renderer_set_stencil_reference(u32 reference);
 ...
 */
API void renderer_set_depth_test_enabled(b8 enabled);
 ...
 */
API void renderer_set_stencil_op(renderer_stencil_op fail_op, renderer_stencil_op pass_op, renderer_stencil_op depth_fail_op, renderer_compare_op compare_op);
 ...
 */
API void renderer_set_stencil_compare_mask(u32 compare_mask);
 ...
 */
API void renderer_set_stencil_write_mask(u32 write_mask);
 ...
 */
API void renderer_texture_read_data(texture* t, u32 offset, u32 size, void** out_memory);
 ...
 */
API renderbuffer* renderer_renderbuffer_get(renderbuffer_type type);
 ...
 * @return True on success; otherwise false.
 */
API b8 renderer_geometry_create(geometry* geometry, u32 vertex_size, u32 vertex_count, const void* vertices, u32 index_size, u32 index_count, const void* indices);
 ...
 * @return True on success; otherwise false.
 */
API b8 renderer_geometry_upload(geometry* geometry);
 ...
 */
API void renderer_geometry_destroy(geometry* geometry);
 ...
 */
API void renderer_geometry_draw(geometry_render_data* data);
 ...
 * @return True on success; otherwise false.
 */
API b8 renderer_texture_map_resources_acquire(struct texture_map* map);
 ...
 */
API void renderer_texture_map_resources_release(struct texture_map* map);
 ...
 */
API void renderer_render_target_destroy(render_target* target, b8 free_internal_memory);
 ...
 */
API b8 renderer_flag_enabled_get(renderer_config_flags flag);
/**
 ...
 */
API void renderer_flag_enabled_set(renderer_config_flags flag, b8 enabled);
 ...
 * @returns True on success; otherwise false.
 */
API b8 renderer_renderbuffer_read(renderbuffer* buffer, u64 offset, u64 size, void** out_memory);
 ...
 * @return True on success; otherwise false.
 */
API b8 renderer_renderbuffer_clear(renderbuffer* buffer, b8 zero_memory);
