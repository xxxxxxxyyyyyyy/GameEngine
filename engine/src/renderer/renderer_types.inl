...
typedef struct renderer_backend {
    ...
    void (*update_global_world_state)(matrix4 projection, matrix4 view, vec3 view_position, vec4 ambient_colour, i32 mode);
    void (*update_global_ui_state)(matrix4 projection, matrix4 view, i32 mode);
