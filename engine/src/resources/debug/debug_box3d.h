...
API void debug_box3d_points_set(debug_box3d *box, vec4* points);

API void debug_box3d_render_frame_prepare(debug_box3d* box, const struct frame_data* p_frame_data);
