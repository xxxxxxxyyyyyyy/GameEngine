...
API b8 debug_grid_create(const debug_grid_config *config, debug_grid *out_grid);
API void debug_grid_destroy(debug_grid *grid);

API b8 debug_grid_initialize(debug_grid *grid);
API b8 debug_grid_load(debug_grid *grid);
API b8 debug_grid_unload(debug_grid *grid);

API b8 debug_grid_update(debug_grid *grid);