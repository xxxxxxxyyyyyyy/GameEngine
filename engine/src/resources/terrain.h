...
API b8 terrain_create(const terrain_config *config, terrain *out_terrain);
API void terrain_destroy(terrain *t);

API b8 terrain_initialize(terrain *t);
API b8 terrain_load(terrain *t);
API b8 terrain_chunk_load(terrain *t, terrain_chunk *chunk);
API b8 terrain_unload(terrain *t);
API b8 terrain_chunk_unload(terrain *t, terrain_chunk *chunk);

API b8 terrain_update(terrain *t);