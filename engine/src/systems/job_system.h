 ...
 */
API void job_system_submit(job_info info);
 ...
 */
API job_info job_create(pfn_job_start entry_point, pfn_job_on_complete on_success, pfn_job_on_complete on_fail, void* param_data, u32 param_data_size, u32 result_data_size);
 ...
 * @returns The newly created job information to be submitted for execution.
 */
API job_info job_create_type(pfn_job_start entry_point, pfn_job_on_complete on_success, pfn_job_on_complete on_fail, void* param_data, u32 param_data_size, u32 result_data_size, job_type type);
 ...
 * @returns The newly created job information to be submitted for execution.
 */
API job_info job_create_priority(pfn_job_start entry_point, pfn_job_on_complete on_success, pfn_job_on_complete on_fail, void* param_data, u32 param_data_size, u32 result_data_size, job_type type, job_priority priority);
 ...
 * @returns The newly created job information to be submitted for execution.
 */
API job_info job_create_with_dependencies(
    pfn_job_start entry_point,
    pfn_job_on_complete on_success,
    pfn_job_on_complete on_fail,
    void* param_data,
 ...
 */
API b8 job_system_query_job_complete(u16 job_id);