 ...
 */
API material* material_system_get_default_pbr(void);
 ...
 * @return True on success; otherwise false.
 */
API b8 material_system_apply_global(u32 shader_id, struct frame_data* p_frame_data, const matrix4* projection, const matrix4* view, const vec4* ambient_colour, const vec3* view_position, u32 render_mode);
 ...
 * @return True on success; otherwise false.
 */
API b8 material_system_apply_local(material* m, const matrix4* model, struct frame_data* p_frame_data);
 ...
 */
API b8 material_system_shadow_map_set(texture* shadow_texture, u8 index);
/**
 ...
 * @returns True on success; otherwise false.
 */
API b8 material_system_irradiance_set(texture* irradiance_cube_texture);
 ...
 */
API void material_system_directional_light_space_set(matrix4 directional_light_space, u8 index);
