 ...
 */
API u32 shader_system_get_id(const char* shader_name);
 ...
 */
API shader* shader_system_get_by_id(u32 shader_id);
 ...
 * @return A pointer to a shader, if found; otherwise 0.
 */
API shader* shader_system_get(const char* shader_name);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_use_by_id(u32 shader_id);
 ...
 */
API u16 shader_system_uniform_location(shader* s, const char* uniform_name);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_uniform_set(const char* uniform_name, const void* value);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_uniform_set_arrayed(const char* uniform_name, u32 array_index, const void* value);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_sampler_set(const char* sampler_name, const texture* t);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_sampler_set_arrayed(const char* sampler_name, u32 array_index, const texture* t);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_uniform_set_by_location(u16 location, const void* value);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_uniform_set_by_location_arrayed(u16 location, u32 array_index, const void* value);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_sampler_set_by_location(u16 location, const struct texture* t);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_sampler_set_by_location_arrayed(u16 location, u32 array_index, const struct texture* t);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_apply_global(b8 needs_update, struct frame_data* p_frame_data);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_apply_instance(b8 needs_update, struct frame_data* p_frame_data);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_bind_instance(u32 instance_id);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_apply_local(struct frame_data* p_frame_data);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_bind_local(void);