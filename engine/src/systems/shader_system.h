 ...
 */
API b8 shader_system_create(const shader_config* config);
 ...
 */
API u16 shader_system_uniform_index(shader* s, const char* uniform_name);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_uniform_set_by_index(u16 index, const void* value);
 ...
 * @return True on success; otherwise false.
 */
API b8 shader_system_sampler_set_by_index(u16 index, const struct texture* t);
