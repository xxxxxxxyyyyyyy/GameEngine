...
texture* texture_system_get_default_diffuse_texture() {
    ...
    ERROR("texture_system_get_default_diffuse_texture called before texture system initialization! Null pointer returned.");
    return 0;
}
...
texture* texture_system_get_default_normal_texture() {
    ...
    ERROR("texture_system_get_default_normal_texture called before texture system initialization! Null pointer returned.");
    return 0;
}
