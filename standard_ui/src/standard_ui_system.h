 ...
 */
API b8 standard_ui_system_initialize(u64* memory_requirement, void* state, void* config);
 ...
 */
API void standard_ui_system_shutdown(void* state);

API b8 standard_ui_system_update(void* state, struct frame_data* p_frame_data);

API void standard_ui_system_render_prepare_frame(void* state, const struct frame_data* p_frame_data);

API b8 standard_ui_system_render(void* state, sui_control* root, struct frame_data* p_frame_data, standard_ui_render_data* render_data);

API b8 standard_ui_system_update_active(void* state, sui_control* control);

API b8 standard_ui_system_register_control(void* state, sui_control* control);

API b8 standard_ui_system_control_add_child(void* state, sui_control* parent, sui_control* child);

API b8 standard_ui_system_control_remove_child(void* state, sui_control* parent, sui_control* child);

API void standard_ui_system_focus_control(void* state, sui_control* control);

// ---------------------------
// Base control
// ---------------------------
API b8 sui_base_control_create(const char* name, struct sui_control* out_control);
API void sui_base_control_destroy(struct sui_control* self);

API b8 sui_base_control_load(struct sui_control* self);
API void sui_base_control_unload(struct sui_control* self);

API b8 sui_base_control_update(struct sui_control* self, struct frame_data* p_frame_data);
API b8 sui_base_control_render(struct sui_control* self, struct frame_data* p_frame_data, standard_ui_render_data* render_data);
 ...
 */
API void sui_control_position_set(struct sui_control* self, vec3 position);
 ...
 */
API vec3 sui_control_position_get(struct sui_control* self);