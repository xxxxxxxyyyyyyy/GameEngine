...
API b8 editor_gizmo_create(editor_gizmo* out_gizmo);
API void editor_gizmo_destroy(editor_gizmo* gizmo);

API b8 editor_gizmo_initialize(editor_gizmo* gizmo);
API b8 editor_gizmo_load(editor_gizmo* gizmo);
API b8 editor_gizmo_unload(editor_gizmo* gizmo);

API void editor_gizmo_refresh(editor_gizmo* gizmo);
API editor_gizmo_orientation editor_gizmo_orientation_get(editor_gizmo* gizmo);
API void editor_gizmo_orientation_set(editor_gizmo* gizmo, editor_gizmo_orientation orientation);
...
API void editor_gizmo_interaction_begin(editor_gizmo* gizmo, struct camera* c, struct ray* r, editor_gizmo_interaction_type interaction_type);
API void editor_gizmo_interaction_end(editor_gizmo* gizmo);
API void editor_gizmo_handle_interaction(editor_gizmo* gizmo, struct camera* c, struct ray* r, editor_gizmo_interaction_type interaction_type);