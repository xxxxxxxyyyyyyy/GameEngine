            ...
            if (strings_equali(trimmed_var_name, "!version")) {
                ...
                switch (mode) {
                    ...
                    case SIMPLE_SCENE_PARSE_MODE_ROOT:
                        DWARN("Format warning: Cannot process name in root node.");
                        break;
                ...
                switch (mode) {
                    default:
                        DWARN("Format warning: Cannot process name in the current node.");
                        break;
                    case SIMPLE_SCENE_PARSE_MODE_DIRECTIONAL_LIGHT:
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_SCENE) {
                    ...
                    DWARN("Format warning: Cannot process description in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_SKYBOX) {
                    ...
                    DWARN("Format warning: Cannot process cubemap_name in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_MESH) {
                    ...
                    DWARN("Format warning: Cannot process resource_name in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_DIRECTIONAL_LIGHT) {
                    ...
                    DWARN("Format warning: Cannot process direction in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_MESH) {
                    ...
                    DWARN("Format warning: Cannot process transform in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_POINT_LIGHT) {
                    ...
                    DWARN("Format warning: Cannot process constant in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_POINT_LIGHT) {
                    ...
                    DWARN("Format warning: Cannot process linear in the current node.");
                }
                ...
                if (mode == SIMPLE_SCENE_PARSE_MODE_POINT_LIGHT) {
                    ...
                    DWARN("Format warning: Cannot process quadratic in the current node.");
                }
            }
        }
